...
You need to add mobile v0.4.7 plugin (https://github.com/messagerie-melanie2/roundcube_mobile) and jquery_mobile v1.1 plugin (https://github.com/messagerie-melanie2/roundcube_jquery_mobile) in plugins folder
